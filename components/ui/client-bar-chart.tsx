...
export default function ClientBarChart({ data }: { data: any[] }) {
    ...
    return (
        <div className="w-full h-[280px] mt-4 relative flex justify-center items-center">
            <BarChart width={500} height={250} data={data} margin={{ top: 20, right: 30, left: -20, bottom: 0 }}>
